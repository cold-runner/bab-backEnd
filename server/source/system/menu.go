...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "12", Path: "upload.js", Name: "upload.js", Component: "view/example/upload.js/upload.js.vue", Sort: 5, Meta: Meta{Title: "媒体库（上传下载）", Icon: "upload.js"}},
		{MenuLevel: 0, Hidden: false, ParentId: "12", Path: "breakpoint", Name: "breakpoint", Component: "view/example/breakpoint/breakpoint.vue", Sort: 6, Meta: Meta{Title: "断点续传", Icon: "upload.js-filled"}},
